export const useStyle = () => {
  ...
  const messageWindow = {
    ...
    errorBorderMsg: {
      base: "w-full rounded border border-slate-300 px-4 py-2 placeholder:text-sm focus:border-sky-400 focus:bg-slate-100",
      showed: "w-full rounded border px-4 border border-red-400 py-2 bg-red-100",
    },
  };
