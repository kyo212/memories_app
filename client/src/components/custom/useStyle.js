export const useStyle = () => {
  ...
  const messageWindow = {
    ...
    successMsg: {
      base: "w-64 translate-y-10 transform fixed bottom-16 left-1/2 -translate-x-1/2 opacity-0 transition-all",
      showed:
        "w-64 border-b border-green-800 fixed bottom-16 left-1/2 -translate-x-1/2 bg-green-600 bg-opacity-10 px-4 py-2 text-sm text-green-800 opacity-100 transition-all duration-500",
    },
    errorBorderMsg: {
