    ...
    <>
      ...
      <div className="flex h-screen w-screen snap-x items-center overflow-x-scroll scroll-smooth">
        {Items.map((item, index) => {
          return (
            // 基準となる背面
            <div key={item.bookId} className="h-screen w-screen snap-start snap-always">
              {/* オブジェクトひとつずつの背面 */}
              ...
              >
                ...
                {/* 表紙 */}
                <div className="z-10 flex h-[400px] w-80 sm:h-[600px] sm:w-[500px] flex-col  items-center rounded-sm border border-slate-300 bg-white text-slate-700 shadow-md">
